...
//		 String test = "<html><body style='text-align:center;'>오늘 아침의 맑은 하늘. 그리고 균형을 유지하듯 폭풍이 몰아치는 듯한 나의 배.<br>\r\n"
//		 		+ "나는 학교에 도착하자마자 빠르게 뛰어 화장실로 달려갔다.<br>\r\n"
//		 		+ "지금 생각해 보면 주변이 뭔가 많이 소란스러웠지만 그땐 눈에 보이는 게 없어서 몰랐지...<br>\r\n"
//		 		+ "그 덕분에 이렇게 될 거라곤 진짜 몰랐지...<br>\r\n"
//		 		+ "화장실에서 나와서 본 광경은 마치 몰래카메라 같았다.<br>\r\n"
//		 		+ "비명소리가 들리는 옆을 쳐다보니 한 사람이 뭔가 이상한 사람들한테 둘러싸여 공격받고 있었다.<br>\r\n"
//		 		+ "공격한 사람?들은 분명히 이성이 없었고 살아있는 것 같지 않았다.<br>\r\n"
//		 		+ "생각할 틈도 없이 그들은 나를 향해 뛰어왔고 나는 필사적으로 뛰어 가장 가까운 강의실로 들어가 문을 닫았다.<br>\r\n"
//		 		+ "다행인 것은 문이 철문이라 <s>그들이</s> 좀비들이 들어오지 못한다는 것이고<br>\r\n"
//		 		+ "안 좋은 것은 통신이 먹통이라는 것이다.<br></body></html>";
		 ...
		 String prolog = "<html><body style='text-align:center;'>오늘 아침의 맑은 하늘. 그리고 균형을 유지하듯 폭풍이 몰아치는 듯한 나의 배.<br>\r\n"
	 		+ "나는 학교에 도착하자마자 빠르게 뛰어 화장실로 달려갔다.<br>\r\n"
	 		+ "지금 생각해 보면 주변이 뭔가 많이 소란스러웠지만 그땐 눈에 보이는 게 없어서 몰랐지...<br>\r\n"
	 		+ "그 덕분에 이렇게 될 거라곤 진짜 몰랐지...<br>\r\n"
	 		+ "화장실에서 나와서 본 광경은 마치 몰래카메라 같았다.<br>\r\n"
